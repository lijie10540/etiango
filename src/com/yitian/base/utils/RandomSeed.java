...
public class RandomSeed {
	...
	public static List getSeedShort(int length,int amount) {
    	if((length>0)&&(length<=8)) {
    		return null;
    	}
     ...
     */
    @SuppressWarnings("unchecked")
	public static List getSeed(int length,int amount) {
    	if((length>0)&&(length<=14)) {
    		return null;
    	}
    	ArrayList randomstringList=new ArrayList();
     ...
     */
    @SuppressWarnings("unchecked")
	public static List getRandomString(int randomtype,int length,int amount) {
    	ArrayList randomstringList=new ArrayList();
    	if(amount<1) {
    		return null;
    	}
     ...
     */
    @SuppressWarnings("unchecked")
	public static List getRandomColor(int colortype) {
    	if(colortype<1) {
    		return null;
    	}
