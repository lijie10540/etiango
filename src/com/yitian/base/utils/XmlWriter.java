...
public class XmlWriter {
  ...
  public XmlWriter(String fName, String encoding) throws IOException {
    this(new FileOutputStream(fName), encoding);
  }
  ...
  public XmlWriter(OutputStream outStream, String encoding) throws IOException {
    ...
    this.writer = new OutputStreamWriter(outStream, this.encoding);
  ...
  /**
   * Close this writerBuffer. It does not close the underlying
   * writerBuffer, but does throw an exception if there are
  ...
  public XmlWriter startDocument(String xmlEncoding, boolean standalone) throws
      IOException {
    print("<?xml ");
    addAttribute("version", "1.0");
    if (xmlEncoding != null) {
      addAttribute("encoding", xmlEncoding);
    }
    if (standalone) {
  ...
  public XmlWriter processingInstruction(String name, String value) throws
      IOException {
    closeOpeningTag();
